# Generated by Django 5.0 on 2023-12-11 07:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precio_total', models.TextField(max_length=100, verbose_name='Precio Total')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preference_contact', models.ForeignKey(help_text='&nbsp', on_delete=django.db.models.deletion.CASCADE, to='core.preferencecontact', verbose_name='Como prefiere ser contactad@')),
                ('type_pqrsd', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.typepqrsd', verbose_name='Tipo de PQRSD')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Total_value', models.IntegerField()),
                ('cotizacion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.cotizacion', verbose_name='Cotización')),
