...
class Cotizacion(models.Model):
    ...
    event_duration = models.PositiveIntegerField(verbose_name="Duración del Evento (horas)")
    ...
    additional_services = models.CharField(max_length=400, verbose_name="Servicios Adicionales")
