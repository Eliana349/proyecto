...
class formularioCarrito(forms.ModelForm):
    ...
    date_start = forms.DateField(widget=forms.DateInput(attrs={'type': 'date'}),label='Fecha de incidente')
    date_finish = forms.DateField(widget=forms.DateInput(attrs={'type': 'date'}),label='Fecha de incidente')
    class Meta:
        model = Carrito
